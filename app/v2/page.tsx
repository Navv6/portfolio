      ...
      <nav className="sticky top-0 bg-white/90 backdrop-blur-md border-b border-gray-200 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <Link href="/v2" className="px-3 py-2 rounded-lg text-sm bg-indigo-100 text-indigo-600 font-semibold">
              v2
            </Link>
            <Link href="/v3" className="px-3 py-2 rounded-lg text-sm hover:bg-gray-100">
              v3
            </Link>
          </div>
        </div>
